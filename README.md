...
1. **[Nome do Projeto 1]**: Descrição breve do que o modelo faz e quais tecnologias usou (ex: LSTM, AWS S3).
2. **[Nome do Projeto 2]**: Descrição de um projeto de visão computacional ou análise preditiva.
